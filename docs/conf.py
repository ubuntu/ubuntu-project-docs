...
html_context = {
    ...
    # header) to ".sphinx/_static" and change the path here (start with
    # "_static") (default is the circle of friends)
...
# NOTE: If this variable is not defined, set to None, or the dictionary is
# empty, the sphinx_reredirects extension will be disabled.
redirects = {}
...
# If you are using the :manpage: role, set this variable to the URL for
# the version that you want to link to:
