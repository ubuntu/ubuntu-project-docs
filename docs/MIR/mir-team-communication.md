...
Ping for MIR meeting members - @didrocks:matrix.org @joalif:matrix.org @seth-arnold:ubuntu.com @paelzer:ubuntu.com @pushkarnk:matrix.org ( @dviererbe:ubuntu.com ) @freyes:ubuntu.com
