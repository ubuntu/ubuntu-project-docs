...
* Debian supports more [hardware architectures](https://www.debian.org/ports/) than Ubuntu, so contributing there extends your reach to additional platforms.
...
3. **Use sbuild** to build against Debian unstable.
