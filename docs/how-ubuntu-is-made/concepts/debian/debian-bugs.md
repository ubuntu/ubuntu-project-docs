...
Since most packages in the Ubuntu `universe` are synced from Debian, fixing bugs there prevents unnecessary divergence and helps the broader Ubuntu community.
