...
If you as a Debian Developer decides you want upload rights for such a large a set of packages for which a package set does not exist in Ubuntu, please consider applying for MOTU or Core Developer instead of using the policy described here.
