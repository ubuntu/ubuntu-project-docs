...
All of these overrides can be removed from `debian/source/lintian-overrides`. After removing the overrides, clean up old build artifacts, rebuild the source package, and re-run Lintian, like you did in the {ref}`updating-rust-lintian-command` step.
