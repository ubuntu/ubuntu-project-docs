...
If in doubt, it is helpful to inspect the `germinate` output (see {ref}`how-seeds-are-used`) for i386
[on Resolute](https://static-reports.ubuntu.com/germinate/germinate-output/release/i386.resolute/i386+build-depends)
or [Noble](https://static-reports.ubuntu.com/germinate/germinate-output/release/i386.noble/i386+build-depends).
...
[germinate output for i386](https://static-reports.ubuntu.com/germinate/germinate-output/release/i386.noble/i386+build-depends)
