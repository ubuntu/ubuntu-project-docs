...
[on Plucky](https://static-reports.ubuntu.com/germinate/germinate-output/release/i386.plucky/i386+build-depends)
or [Jammy](https://static-reports.ubuntu.com/germinate/germinate-output/release/i386.jammy/i386+build-depends).
