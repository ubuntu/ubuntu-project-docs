...
These have yet to be imported into the new documentation. See the
`old documentation <https://wiki.ubuntu.com/StableReleaseUpdates#Documentation_for_Special_Cases>`__
for now.
