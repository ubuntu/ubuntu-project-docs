...
5. If you are looking to update packages using a special type of SRU on
   a routine basis, follow :ref:`Request a package-specific
   non-standard process
   <howto-request-package-specific-non-standard-process>` below instead.

The remaining guides in this section are for the special types of SRU
listed at :ref:`Reference → Special types of SRU
