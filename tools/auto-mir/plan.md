...
## Next Phases After 7b

1. Phase 8A - Deterministic coverage completion
...
2. Phase 8B - Adapter completion
   - Implement the 6 missing adapters listed above.
   - Exit criteria: all catalog adapters present in supported collector map.

3. Phase 8C - Corpus validation
   - Run against recency corpus in `old-MIRs-as-input`.
   - Exit criteria: template-conformant outputs and acceptable review quality.

4. Phase 9 - Hardening + CI gates
   - Make `check`, `format`, and `check-review-template` required gates.
   - Add strict blueprint/check consistency checks where practical.

5. Phase 10 - Docs closure
   - Refresh architecture docs and developer usage around the catalog-driven
